...
```
portfolio/
├── index.html        Sheet 01 — Dashboard: hero, quick stats, sheet index, featured project
├── education.html    Sheet 02 — Education: degree info, coursework, skill bars, tech stack
├── projects.html      Sheet 03 — Projects: all 5 projects with Code / Live Demo buttons
